...
export default function Terms() {
  return (
    <AppLayout>
      <div className="mt-10 md:px-xPadLG px-xPadSM">
        <h2 className="text-center font-bold mt-24 text-[25px] md:text-[40px]">
        ...
        <div className="ant-table-wrapper mt-3 css-p8b6i">
          <div className="ant-spin-nested-loading css-p8b6i">
            <div className="ant-spin-container">
              <div className="ant-table ant-table-bordered css-p8b6i">
                    ...
                    <table style={{ tableLayout: "auto" }}>
                      ...
                      <tbody className="ant-table-tbody">
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">Affiliate</td>
                        ...
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">Account</td>
                          <td className="ant-table-cell">
                        ...
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">
                            ...
                            'Our' in this Agreement) refers to Dkeralutive
                            limited.
                          </td>
                        </tr>
                        <tr className="ant-table-row ant-table-row-level-0">
                          <td className="ant-table-cell">4</td>
                          <td className="ant-table-cell">Country</td>
                          <td className="ant-table-cell">refers to Nigeria</td>
                        </tr>
                        <tr className="ant-table-row ant-table-row-level-0">
                          <td className="ant-table-cell">5</td>
                          <td className="ant-table-cell">Content</td>
                          <td className="ant-table-cell">
                        ...
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">Device</td>
                          <td className="ant-table-cell">
                        ...
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">Feedback</td>
                          <td className="ant-table-cell">
                        ...
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">Products</td>
                          <td className="ant-table-cell">
                            refer to the products or items offered for sale on
                            the Service.
                          </td>
                        </tr>
                        <tr className="ant-table-row ant-table-row-level-0">
                          <td className="ant-table-cell">9</td>
                          <td className="ant-table-cell">Orders</td>
                          <td className="ant-table-cell">
                        ...
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">Promotions</td>
                          <td className="ant-table-cell">
                            refer to contests, sweepstakes or other promotions
                            offered through the Service.
                          </td>
                        </tr>
                        <tr className="ant-table-row ant-table-row-level-0">
                          <td className="ant-table-cell">11</td>
                          <td className="ant-table-cell">Services</td>
                          <td className="ant-table-cell">
                        ...
                        <tr className="ant-table-row ant-table-row-level-0">
                          ...
                          <td className="ant-table-cell">Website</td>
                          <td className="ant-table-cell">
                            refers to https://dkerulative.com.ng
                          </td>
                        </tr>
                        <tr className="ant-table-row ant-table-row-level-0">
                          <td className="ant-table-cell">15</td>
                          <td className="ant-table-cell">You</td>
                          <td className="ant-table-cell">
        ...
        <div className="my-12 terms">
          ...
          <p>
            ...
            so constitutes a br /each of the Terms, which may result in
          ...
          <p>
            ...
            notify Us immediately upon becoming aware of any br /each of
          ...
          <p>
            ...
            limitation if You br /each these Terms and Conditions.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            /each constitute a waiver of any subsequent br /each.
          </p>
          <br />
