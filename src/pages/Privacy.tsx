...
export default function Privacy() {
  return (
    <AppLayout>
      <div className="my-10 md:px-xPadLG px-xPadSM privacy">
        <h3 className="text-center">PRIVACY POLICY</h3>
        <p className="text-center">Last updated 1st June 2024</p>
        <br />
        <p>
          This privacy policy for D'keralutive Limited, describes how and why we
          might collect, store, use, and/or share ("process") your information
          when you use our services ("Services"), such as when you:
        </p>
        <ul className="mt-3">
          <li>
            <span className="font-semibold">1.</span> Visit our website at{" "}
            <a
          ...
          <li>
            <span className="font-semibold">2.</span> Download and use our
            application(s), such as our mobile application, Facebook application
            or any of our applications that links to this privacy policy.
          </li>
          <li>
            <span className="font-semibold">3.</span>Engage with us in other
            related ways ― including any sales, marketing, or events.
          </li>
          <li>
            <span className="font-semibold">4.</span> Questions or concerns?
            ...
            questions or concerns, please contact us at tech@dkeralutive.com.
          </li>
        </ul>
        <br />
        ...
        <br />
        <p>
          <span className="font-bold">What are your rights?</span> Depending on
        ...
        <br />
        <p>
          <span className="font-bold">How do I exercise my rights?</span> The
          easiest way to exercise your rights is by filling out our data subject
          access request form or by contacting us. We will consider and act upon
          any request in accordance with applicable data protection laws.
        </p>
        <br />
        <p>
          Want to learn more about what we do does with any information we
        ...
        <p className="uppercase">
          13. What categories of personal information do we collect?
        </p>
        <p className="uppercase">
          14. Will your information be shared with anyone else?
        </p>
        <p className="uppercase">15. DO WE MAKE UPDATES TO THIS NOTICE?</p>
        <p>
          16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM
          YOU?
        </p>
        <p className="uppercase">17. Return &amp; Refund Policy</p>
        <br />
        ...
        <p>
          ...
          when you register on the services we offer; express an interest in
        ...
        <ul className="mt-3">
          <li>
            <span className="font-bold">1.</span> Name
          </li>
          <li>
            <span className="font-bold">2.</span>Address
          </li>
          <li>Phone number and email contacts</li>
          <li>
            <span className="font-bold">3.</span>Sensitive Information. [We do
            not process sensitive information. / When necessary, with your
            consent or as otherwise permitted by applicable law, we process the
            following categories of sensitive information:
          </li>
          <li>
            <span className="font-bold">4.</span>Debit card number
          </li>
          <li>
            <span className="font-bold">5.</span>Security code associated with
            Debit card payment
          </li>
          <li>
            <span className="font-bold">6.</span>Payment Data. We may collect
            data necessary to process your payment if you make purchases, such
            as your payment instrument number (such as a debit card number), and
            the security code associated with your payment instrument. All
            payment data is stored by [Vendor Name]. You may find their privacy
            notice link(s) here: [Vendor Privacy Policy].
          </li>
        </ul>
        <br />
        <p>
        ...
        <br />
        <h3>Information automatically collected</h3> <br />
        <p>
        ...
        <p>
          ...
          default access your Facebook basic account information, including your
          name, email, gender, birthday, current city, and profile picture URL,
          as well as other information that you choose to make public. We may
          also request access to other permissions related to your account, such
          as friends, check-ins, and likes, and you may choose to grant or deny
          us access to each individual permission. For more information
          regarding Facebook permissions, refer to the Facebook Permissions
          Reference page.
        </p>
        <br />
        ...
        <ul>
          ...
          <li>
            ...
            information see our Cookie Notice: [Cookie Notice URL].
          </li>
          <li>
        ...
        <p>
          ...
          is necessary and we have a valid legal reason to do so under
        ...
        <ul>
          ...
          <li>
            ...
            evidence in litigation in which we are involved. // Vital Interests.
        ...
        <p>
          ...
          this link. We use certain Google Maps Platform APIs to retrieve
          certain information when you make location-specific requests. This
          includes: [List of Information Collected], and other similar
          information.
        </p>
        <br />
        <p>
          ...
          location for [#] months. You may revoke your consent anytime by
          ...
          our Cookie Notice, which can be found at this link: [Cookie Notice
          URL].
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          set out in our Cookie Notice: [Cookie Notice URL].
        </p>
        <br />
        ...
        <p>
          ...
          choose to make public on such a social media platform. [If you log in
          using Facebook, we may also request access to other permissions
        ...
        <p>
          ...
          period of time in which users have an account with us / [#] months
          past the termination of the user’s account / [#] months past the start
          of the idle period of the user’s account / other].
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          [Other] or by contacting us using the details provided in the section
        ...
        <p>
          ...
          please see our Cookie Notice: [Cookie Notice URL].
        </p>
        <br />
        <p>
        ...
        <p>Click redirects: [Click Redirects]</p>
        <p>
          Social media plugins: [Social Media Plugins]. We use social media
          features, such as a "Like" button, and widgets, such as a "Share"
          button in our Services. Such features may process your Internet
          Protocol (IP) address and track which page you are visiting on our
          website. We may place a cookie to enable the feature to work
          ...
          social media platform before accessing or using the Services. Social
        ...
        <p>
          ...
          Learn more about who we disclose personal information to in the
        ...
        <br />
        <h3 className="uppercase">15. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
        <p>
        ...
        <br />
        <h3 className="uppercase">17. Return &amp; Refund Policy</h3>
        <p>
          Our Return and Refund Policy was last updated 11th of June 2024
          <hr />
          <span>
            Thank you for shopping at{" "}
            <a href="https://dkerulative.com.ng/">
              https://dkerulative.com.ng/
            </a>
          </span>
          <hr />
        ...
        <ul>
          <li>
            ...
            "Our" in this Agreement) refers to D'keralutive Limited.
          </li>
          <li>
          ...
          <li>
            ● “Website” refers to D'keralutive accessible from
            https://d'kerulative.com.ng/
          </li>
          <li>
            ● “You” means the individual accessing or using the Service, or the
            company, or other legal entity on behalf of which such individual is
            accessing or using the Service, as applicable. <br />
            Your Order Cancellation Rights Generally, there is a no refund and
            return policy however where goods are defective or not in accordance
            with the specification of your orders, You are entitled to cancel
            Your Order within 14 days. <br />
          ...
          <li>
            ● By sending us an email: We will reimburse You no later than 14
            days from the day on which We receive the returned Goods. We will
